...
<head>
    ...
    <title>Taste Of Ummi - Exquisite Pastries</title>
    <!-- Google Fonts -->
...
<body>
    <header class="navbar">
    <div class="container">
        <h1 class="logo"><a href="index.html">Taste Of Ummi</a></h1>
    ...
    <main>
        ...
        <section id="about">
            <div class="container about-content">
                <div class="about-text">
                    ...
                    <p>Welcome to Taste Of Ummi, where every dish tells a story of passion, tradition, and culinary innovation. Founded by Chef Ummu Salma, our restaurant is a celebration of exquisite flavors, locally sourced ingredients, and a dining experience designed to delight all your senses.</p>
        ...
        <section id="menu">
            <div class="container">
                ...
                <div class="menu-tabs">
                    <button class="tab-button active" data-category="appetizers">Gourmet Chops</button>
        ...
        <section id="gallery">
            <div class="container">
                <h2>Moments at Taste Of Ummi</h2>
